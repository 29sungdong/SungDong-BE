...
public class SubPlaceController {
    ...
    @GetMapping("")
    public ResponseEntity<SubPlacesResponseDTO> findSubPlaces(@RequestParam Long place_id) {
        SubPlacesResponseDTO subPlacesResponseDTO = subPlaceService.findSubPlaces(place_id);
