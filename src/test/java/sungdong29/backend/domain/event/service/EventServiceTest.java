...
//
//        // then
//        assertThat(eventListDTO.getEvents().get(0).getPlaceId()).isEqualTo(1L);
//    }
//
...
//        category.add(SortCategoryType.PARK);
//        category.add(SortCategoryType.FARM);
//
//        // when
//        EventListResponseDTO eventListDTO = eventService.getEventList(category, null);
//
//        // then
//        assertThat(eventListDTO.getEvents().size()).isEqualTo(2);
//    }
//}